...
class FunctionHandler:
    ...
    def register_nessary_functions(self):
        ...
        self.function_registry.register_function("handle_device_lamp")
        self.function_registry.register_function("timer_music")
        self.function_registry.register_function("handle_device_movement")
        self.function_registry.register_function("handle_device_ultrasonic")
        self.function_registry.register_function("handle_device_gesture")
        self.function_registry.register_function("health_music")
        self.function_registry.register_function("change_role")
